  ...
  if (localStorage.getItem("data") != null && homePage && adminPage) {
    ...
    Object.values(test).map((item) => {
      ...
      homePage.innerHTML += `
        <section class="landingpage-section">
        <div class="card">  
        <img class="product-image" src="https://images.unsplash.com/photo-1588099768550-4014589e03e0?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=634&q=80" style="width:100%"->
